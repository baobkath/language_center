...
$this->title = Yii::t('frontend','Languecenters');
...
foreach ($models as $mod){
    ...
    <div class='row box-center' style='position: relative;'>
        <div class='col-md-3 '>";
            ...
            echo "<div class='rating'><div><img src='{$mod->getImageRate()}' alt='Based on {$mod->rate} reviews.' class='img-responsive center-block' /></div></div>
        </div>
        <div class='col-md-9' >
            <div  class='name'>";
        ...
        <div class='row more'>";
        echo Html::a(Yii::t('frontend','more...'),['languecenter/view','id' => $mod->ID]);
        echo "</div>
    </div>";
    }?>
